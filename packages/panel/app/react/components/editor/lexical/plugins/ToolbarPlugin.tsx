...
export default function ToolbarPlugin() {
  ...
  return (
    <div className="toolbar" ref={toolbarRef}>
      ...
      <button className="toolbar-item" aria-label="Quote" onClick={formatQuote}>
        <i className="format quote" />
      </button>
      <button className="toolbar-item spaced" aria-label="Bullet List" onClick={formatBulletList}>
        <i className="format bullet-list" />
      </button>
      <button className="toolbar-item spaced" aria-label="Numbered List" onClick={formatNumberedList}>
        <i className="format numbered-list" />
      </button>
      <button className="toolbar-item" aria-label="Code Block" onClick={formatCode}>
